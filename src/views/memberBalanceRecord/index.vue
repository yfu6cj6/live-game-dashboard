<template>
  <div class="w-100 h-100">
    <template v-if="device === 'mobile'">
      <div class="scroll-wrap memberBalanceRecord">
                ...
                <div class="data_content w-100">
                  ...
                  <div class="d-flex flex-wrap justify-content-between base">
                    ...
                    <div class="d-flex flex-colum field">
                      ...
                      <span class="news text-yellow" @click.stop="agentInfoClick(item)">{{ item.superiorAgent }}</span>
                    </div>
                    <div class="d-flex flex-colum field">
                    ...
                    <div class="filters flex-wrap">
                      <div class="filter-inner">
                        <div class="filter-options">
                          ...
                          <div class="options">
                            <div>
                              <div class="option">
                                ...
                                <div class="input-filter">
                                  <div class="el-input">
                                    <input v-model="searchForm.orderNumber" type="text" autocomplete="off" :placeholder="$t('__transactionNumber')" class="el-input__inner">
                                  </div>
                                </div>
                                <span class="suffix-label" />
                              </div>
                          ...
                          <div class="options">
                            <div>
                              <div class="option">
                                ...
                                <div class="input-filter">
                                  <div class="el-input">
                                    <input v-model="searchForm.betOrderNumber" type="text" autocomplete="off" :placeholder="$t('__orderNumber')" class="el-input__inner">
                                  </div>
                                </div>
                                <span class="suffix-label" />
                              </div>
                          ...
                          <div class="options member_select_options">
                            <div>
                              <div class="option">
                                <span class="prefix-label" />
                                <div class="comp selected-filter custom">
                    ...
                    <div class="agent-group">
                      <div class="w-100 items">
                        <div class="agent-list-basic list-row">
                          <span class="index" />
                          <div class="list-item d-flex align-items-center" style="width: 170px; flex-wrap: wrap;">
                          ...
                          <div class="list-item d-flex align-items-center" style="width: 185px; flex-wrap: wrap; margin-left: -10px;">
                            <span class="label font-weight-bold text-black" style="width: 100%; padding-bottom: 0.5rem;">{{ $t('__member') }}</span>
                          </div>
                          ...
                          <div class="list-item d-flex align-items-center" style="width: 145px; flex-wrap: wrap;">
                            <span class="label font-weight-bold text-black" style="width: 100%; padding-bottom: 0.5rem;">{{ $t('__orderNumber') }}</span>
                          </div>
                      ...
                      <div class="agent-group">
                        ...
                        >
                          <div class="agent-list-basic list-row align-items-center">
                            ...
                            <div class="list-item d-flex align-items-start" style="width: 170px; flex-wrap: wrap;">
                              <span class="value">
                            ...
                            <div class="list-item d-flex align-items-start" style="width: 30px; min-width: 40px; flex-wrap: wrap;">
                              <span class="value d-flex">
                                <span class="solid-circle align-self-center clickable small" :class="`memberBalanceRecord-agent-${item.id}`">
                                  <div class="fas black">
                            ...
                            <div class="list-item d-flex align-items-start" style="width: 30px; min-width: 40px; flex-wrap: wrap;">
                              <span class="value d-flex">
                                <span class="solid-circle align-self-center clickable small" :class="`memberBalanceRecord-member-${item.id}`">
                                  <div class="fas black">
                            ...
                            <div class="list-item d-flex align-items-start" style="width: 185px; flex-wrap: wrap; margin-left: -10px;">
                              <span class="value">
                            ...
                            <div class="list-item d-flex align-items-start" style="width: 145px; flex-wrap: wrap;">
                              <span class="value">
...
export default {
  ...
  methods: {
    ...
    addSelectFilter() {
      ...
      this.addSelectDropDownFilter('options member_select_options', () => {
    ...
    agentInfoClick(rowData) {
      ...
      this.selectForm.className = `.memberBalanceRecord-agent-${this.selectForm.id}`
      this.$nextTick(() => {
    ...
    memberInfoClick(rowData) {
      this.closeInfoEnumEven()
      this.selectForm = JSON.parse(JSON.stringify(rowData))
      this.selectForm.className = `.memberBalanceRecord-member-${this.selectForm.id}`
      this.$nextTick(() => {
